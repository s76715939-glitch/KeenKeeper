...
const FriendPage = ({ params }) => {
  ...
  if (!friend) {
    return <h2 className="text-2xl text-gray-500 text-center py-20">Not Found Friend Data</h2>;
  }
        ...
        <div className="md:col-span-8 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="bg-white border border-[#eaeaea] shadow rounded-lg py-7 flex flex-col items-center justify-center">
              <p className="text-3xl font-bold text-[#264336]">{friend.days_since_contact}</p>
              <p className="text-[13px] text-[#80868b] mt-2">Days Since Contact</p>
            </div>
          ...
          <div className="bg-white border border-[#eaeaea] shadow-[0_2px_10px_rgb(0,0,0,0.03)] rounded-lg p-6 flex items-center justify-between mt-2">
            <div>
              <h3 className="text-[16px] font-semibold text-[#264336]">Relationship Goal</h3>
              <p className="text-[14px] text-[#5f6368] mt-1.5">
                Connect every <span className="font-bold text-[#202124]">{friend.goal} days</span>
              </p>
            </div>
          ...
          <div className="bg-white border border-[#eaeaea] shadow-[0_2px_10px_rgb(0,0,0,0.03)] rounded-lg p-5 mt-2">
            <h3 className="text-[16px] font-semibold text-[#264336] mb-4">Quick Check-In</h3>
            <div className="grid grid-cols-3 gap-4">
              <button onClick={()=>handleHistory("Call")} className="cursor-pointer border border-[#eaeaea] rounded-lg py-5 flex flex-col items-center justify-center gap-2 hover:bg-[#f8f9fc] transition-colors">
                <FiPhone className="text-[22px] text-[#3c4043]" />
                <span className="text-[14px] text-[#3c4043] font-medium">Call</span>
              </button>
              <button onClick={()=>handleHistory("Text")} className="cursor-pointer border border-[#eaeaea] rounded-lg py-5 flex flex-col items-center justify-center gap-2 hover:bg-[#f8f9fc] transition-colors">
                <FiMessageSquare className="text-[22px] text-[#3c4043]" />
                <span className="text-[14px] text-[#3c4043] font-medium">Text</span>
              </button>
              <button onClick={()=>handleHistory("Video")} className="cursor-pointer border border-[#eaeaea] rounded-lg py-5 flex flex-col items-center justify-center gap-2 hover:bg-[#f8f9fc] transition-colors">
                <FiVideo className="text-[22px] text-[#3c4043]" />
                <span className="text-[14px] text-[#3c4043] font-medium">Video</span>
              </button>
              <ToastContainer/>
            </div>
          </div>
